...
static void jj_dump_frames(void)
{
...
static void jj_sigaction_handler(int sig, siginfo_t *info,  void *ctx)
{
...
void jj_trackSignalCrash()
{
    struct sigaction mySigAction;
	mySigAction.sa_sigaction = jj_sigaction_handler;
