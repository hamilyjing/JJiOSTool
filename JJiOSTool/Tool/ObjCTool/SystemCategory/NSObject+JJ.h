...
+ (u_int32_t)jj_random;
+ (u_int32_t)jj_randomWithMaxValue:(u_int32_t)maxValue minValue:(u_int32_t)minValue;
+ (u_int32_t)jj_randomWithMaxValue:(u_int32_t)maxValue;
...
+ (Class)jj_swiftClassFromClassName:(NSString *)className;
